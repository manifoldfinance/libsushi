// @filename ChainRpc Constants
// @smmary Enabling Better ChainId / RPC mgmt
...
/**
 * Custom Wagmi Chains that aren't provided by WAGMI
 */
...
const CHAIN_NAME_OVERRIDE: {
  ...
  [CHAIN_ID.celo]: 'Celo',
  [CHAIN_ID.xdai]: 'Gnosis SmartChain'
})
...
/**
 * Overwrites the name of the chain with Sushi's preferred name.
 * @param chain
 */
...
/**
 * Pushes the preferred RPC URLS for the chain with Sushi's preferred RPC URL to the front.
 * @param chain
 */
